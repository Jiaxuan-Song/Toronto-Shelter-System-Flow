...
author:
  - Jiaxuan Song
thanks: "The GitHub Repository containing all data, R code, and other files used in this project is located here: <https://github.com/Jiaxuan-Song/Tracking-Homelessness-in-Toronto.git>"
date: 24-09-2024
date-format: long
...
data <- read_csv("/Users/sjx/Desktop/Tracking-Homelessness-in -Toronto/data/analysis_data/filtered_data.csv")
